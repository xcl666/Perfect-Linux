# Path to your oh-my-zsh installation.
  export ZSH=$HOME/Perfect-Linux/.oh-my-zsh
...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:/usr/sbin:/bin:/usr/games:/sbin"
